            ...
            <Row className='justify-content-center'>
                <Col lg={8}>
                    {showShoppingCart ? (
                        ...
                        <MenuList place={place} shoppingCart={shoppingCart} onOrder={onAddItemtoShoppingCart} color={place.color} font={place.font}/>
                    )}
                </Col>
            </Row>

            {totalQuantity ? (
                <OrderButton variant='standard' style={{ backgroundColor: place.color }} onClick={() => setShowShoppingCart(!showShoppingCart)}>
