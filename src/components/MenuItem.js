...
const MenuItem = ({ item, onEdit, onRemove, onOrder, color }) => (
    <Container active={item.is_available}>
        ...
        <Col xs={7} className='d-flex flex-column justify-content-between w-101'>
            <div>
            ...
            <div className='d-flex justify-content-between align-items-end'>
                <div>
                    ...
                    {onOrder ? (
                        <Button variant='standard' style={{backgroundColor: color}} className='mt-2' size='sm' onClick={() => onOrder(item)}>
